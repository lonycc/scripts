...
$encrypt = new Encrypt();
//利用bg.bmp加密file.txt, 并生成新的文件output.bmp
$encrypt->encryptFile('file.txt', 'bg.bmp', 'output.bmp') or die($encrypt->getErrorMsg());
//解密output.bmp, 生成原始文件保存到指定目录
$encrypt->decryptFile('output.bmp', '/') or die($encrypt->getErrorMsg());
